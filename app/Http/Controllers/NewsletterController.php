...
class NewsletterController extends Controller
{
    ...
    public function send(Request $request)
    {
        ...
        // Handle the file upload (optional attachment)
        $attachmentFile = null;
        ...
        foreach ($recipients as $recipient) {
            ...
            try {
                ...
                // Attach the file if it exists (directly without saving it)
                if ($attachmentFile) {
                    $mail->addAttachment($attachmentFile->getRealPath(), $attachmentFile->getClientOriginalName());
                }
